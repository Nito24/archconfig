...
LIST_OF_APPS="neofetch xf86-video-vesa xorg xorg-server xorg-xinit qtile picom archlinux-wallpaper unclutter dunst brightnessctl alacritty firefox alsa-utils python-psutil pulseaudio pulseaudio-alsa volumeicon zsh lsd powerline-fonts eatmydata"
