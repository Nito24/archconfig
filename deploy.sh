...
LIST_OF_DEVEL_APPS="base-devel git make wget curl p7zip neovim" #git is not really needed since thats how you have suposedly downloaded the config. Same goes with nvim, it should already be installed
