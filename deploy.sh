...
LIST_OF_APPS="neofetch qtile picom archlinux-wallpaper unclutter dunst xbindkeysrc alacritty alsa-utils pulseaudio pulseaudio-alsa volumeicon zsh powerline-fonts"
